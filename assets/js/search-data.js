    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-wallet-ai-ai-powered-personal-finance-assistant-web-app",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-financial-text-sentiment-analysis-using-llm-for-stock-market-prediction",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/JengYangKong-Resume.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%65%6E%67%79%61%6E%67%31%33%30%37@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jengyangkong", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/jengyang7", "_blank");
        },
      },{
      id: 'light-theme',
